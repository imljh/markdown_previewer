...
![React Logo w/ Text](https://goo.gl/Umyytc)`;
    ...
    handlePreviewerMaximize() {
        this.setState({
            isPreviewerMaximized: !this.state.isPreviewerMaximized
        });
    }
        ...
        return (
            <div>
                <MdEditor
                    ...
                    handleMaxisize={this.handleEditorMaximize}
                    isEditorMaximized={this.state.isEditorMaximized}
                    isPreviewerMaximized={this.state.isPreviewerMaximized}
                />
                <MdPreviewer
                    preview={marked(this.state.markdown)}
                    handleMaxisize={this.handlePreviewerMaximize}
                    isEditorMaximized={this.state.isEditorMaximized}
                    isPreviewerMaximized={this.state.isPreviewerMaximized}
                />
            </div>
